...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        [Option("agree-tos", Required =true, HelpText = "Agree to the Terms of Service.")]
        ...
        [Option("eab-kid", HelpText = $"External Account Binding Key ID. Environment variable '{EnvironmentVariables.AZ_ACME_EAB_KID}' can also be used.")]
        public string? EabKid { get; set; }

        [Option("eab-hmac-key", HelpText = $"External Account Binding HMAC Key. Environment variable '{EnvironmentVariables.AZ_ACME_EAB_KEY}' can also be used.")]
