...
//    public class Demo
//    {
//        //public async Task ZeroSsl(ILogger logger)
//        //{
...
//        //    var certesConfiguration = new CertesAcmeConfiguration(new Uri("https://acme.zerossl.com/v2/DV90"));
...
//        //    IDnsZone azureDns = new AzureDnsZone(logger, dnsClient, dnsResourceId);
...
//        public async Task LetsEncryptStaging(ILogger logger)
//        {
//            var kvUri = new Uri("https://kvazacmedev.vault.azure.net/");
//            var azureCreds = new DefaultAzureCredential();
//            var kvSecretClient = new SecretClient(kvUri, azureCreds);
...
//            var certesConfiguration = new CertesAcmeConfiguration(new Uri("https://acme-staging-v02.api.letsencrypt.org/directory"));
...
//            // prepare
//            var certificateRequest = new CertificateRequest("cert-lets-encrypt-stg-azacme-dev", "lestg-demo.azacme.dev", 
//                new List<string>() 
//                {
//                    "lestg-demo1.azacme.dev", 
//                    "lestg-demo2.azacme.dev"
//                }
//            );

//            var runner = new Runner(secretStore, certificateStore, acmeProvider, azureDns);
//            await runner.Order(credential, certificateRequest);
